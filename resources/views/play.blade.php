    ...
    <section id="play">
        ...
        <div class="consultArea">
            ...
            <div class="conclusionArea">
                ...
                <x-Button onclick="saveConsultation()" class="saveConsultationButton">@lang('messages.conclusion.register')<img width="40.0rem" src="assets/icons/pencil.png"></x-Button>
